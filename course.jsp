...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="manage_teachers.jsp">Manage Teacher</a>
    ...
    <div class="content">
        ...
        <div class="dashboard">
            ...
            <div class="card">
                <h3>Add course</h3>
                <p>Click to create a new course</p>
                <a href="admin-courses.jsp" class="btn">Add course</a>
            </div>

            <!-- View Quizzes Card -->
            <div class="card">
                <h3>View course</h3>
                <p>Click to view all course</p>
                <a href="student-courses.jsp" class="btn">View course</a>
            </div>
        </div>
    </div>
